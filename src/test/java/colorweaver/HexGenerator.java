...
public class HexGenerator extends ApplicationAdapter {
    ...
    private static int[] oklloyd63 = {
            0x00000000, 0x000000FF, 0x202020FF, 0x3D3D3DFF, 0x4F4F4FFF, 0x636363FF, 0x808080FF, 0x9E9E9EFF, 0xB9B9B9FF, 0xD1D1D1FF,
            0xE8E8E8FF, 0xFFFEFEFF, 0xAE2827FF, 0xEE6B48FF, 0xD05733FF, 0xEAAA83FF, 0xE38C44FF, 0x825426FF,
            0xA17934FF, 0xE1B337FF, 0xB99B38FF, 0xEDD150FF, 0xD9F747FF, 0xAFE441FF, 0xA0C755FF, 0x87AB44FF,
            0xD7F6A8FF, 0xB2DF98FF, 0x4CDD3FFF, 0x439340FF, 0x336C31FF, 0x3DBC39FF, 0x56F854FF, 0x4AD6A3FF,
            0x40AF91FF, 0x5AF4D3FF, 0x5FCCE6FF, 0x4CA9DEFF, 0x3D84D1FF, 0x2C61A6FF, 0x20236AFF, 0x2726C9FF,
            0x543DE8FF, 0x9064DEFF, 0xAF8AE2FF, 0x7048A4FF, 0x5D1F7CFF, 0x9824C4FF, 0xD22CD9FF, 0xE4A1DFFF,
            0xEC57E0FF, 0xB12270FF, 0xB4638DFF, 0xE8318EFF, 0x894465FF, 0xE57AA1FF, 0x671D2AFF, 0xE92A38FF,

            0xFF0000FF, 0x00FF00FF, 0x0000FFFF, 0xFFFF00FF, 0x00FFFFFF, 0xFF00FFFF,
...
//    }
    ...
    public static int[] PALETTE = Coloring.YAM4;
    public static String NAME = "yam4-255";
