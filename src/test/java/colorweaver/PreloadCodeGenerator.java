...
public class PreloadCodeGenerator extends ApplicationAdapter {
    ...
    public void create() {
        ...
        PaletteReducer reducer = new PaletteReducer(munsellish255, PaletteReducer.rgbStupiderMetric);
        generatePreloadCode(reducer.paletteMapping, "MunsellishRGBPreload.txt");
        Gdx.files.local("MunsellishRGBPreload.dat").writeBytes(reducer.paletteMapping, false);
        Gdx.app.exit();
    }
    /**
