...
public class AutomaticPaletteTransformer extends ApplicationAdapter {
    ...
    public void create() {
        ...
        Gdx.files.local("palettes/genIpt/").mkdirs();
...
//        FileHandle hex = Gdx.files.local("palettes/hex/"+HexGenerator.NAME+".hex");{
            ...
            png8.palette = new PaletteReducer(PALETTE, PaletteReducer.iptQuickMetric);
            ...
            try {
                png8.writePrecisely(Gdx.files.local("palettes/genIpt/" + name + ".png"), pix, false);
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            try {
                png8.writePrecisely(Gdx.files.local("palettes/genIpt/" + name + "_GLSL.png"), p2, false);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
