 ...
 */
public class ExperimentalPaletteTransformer extends ApplicationAdapter {
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new ExperimentalPaletteTransformer(), config);
    }
...
//        Gdx.files.local("palettes/yccRgbEuc2/").mkdirs();
