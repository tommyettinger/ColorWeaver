                ...
                if (hasTransparent && (color & 0x80) == 0) /* if this pixel is less than 50% opaque, draw a pure transparent pixel. */
                    ...
                    switch ((px << 1 & 2) | (y & 1)){
                        case 0:
                            ...
                            break;
                        case 1:
                            noise += (BlueNoise.TRIANGULAR_BLUE_NOISE[0][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-5f;
                            noise += ((y * 0x91E10DA5C79E7B1DL - px * 0xC13FA9A902A6328FL) >> 41) * 0x1p-20f;
                            break;
                        case 2:
                            noise += (BlueNoise.TRIANGULAR_BLUE_NOISE[0][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-6f;
                ...
                if (hasTransparent && (color & 0x80) == 0) /* if this pixel is less than 50% opaque, draw a pure transparent pixel. */
                    ...
                    switch ((px << 1 & 2) | (y & 1)){
                        case 0:
                            ...
                            eg += (BlueNoise.TRIANGULAR_BLUE_NOISE[1][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-5f;
                            eg += ((px * -0xC13FA9A902A6328FL + y * 0x91E10DA5C79E7B1DL) >> 41) * 0x1p-20f;
                            eb += (BlueNoise.TRIANGULAR_BLUE_NOISE[2][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-6f;
                            eb += ((y * 0xC13FA9A902A6328FL + px * -0x91E10DA5C79E7B1DL) >> 41) * 0x1.8p-20f;
                            break;
                        case 1:
                            er += (BlueNoise.TRIANGULAR_BLUE_NOISE[0][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-5f;
                            er += ((px * -0xC13FA9A902A6328FL + y * 0x91E10DA5C79E7B1DL) >> 41) * 0x1p-20f;
                            eg += (BlueNoise.TRIANGULAR_BLUE_NOISE[1][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-6f;
                            ...
                            break;
                        case 2:
                            er += (BlueNoise.TRIANGULAR_BLUE_NOISE[0][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-6f;
                        ...
                        default: // case 3:
                            ...
                            eg += ((px ^ y) % 9 - 4);
                            eg += ((px * 0xC13FA9A902A6328FL + y * 0x91E10DA5C79E7B1DL) >> 41) * 0x1p-20f;
                            eb += (BlueNoise.TRIANGULAR_BLUE_NOISE[2][(px & 127) | (y & 127) << 7] + 0.5f) * 0x1p-5f;
                            eb += ((px * -0xC13FA9A902A6328FL + y * 0x91E10DA5C79E7B1DL) >> 41) * 0x1p-20f;
                            break;
                    }
