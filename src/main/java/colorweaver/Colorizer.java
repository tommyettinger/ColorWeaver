...
//        }
    ...
    public static final int[] TinctureBonusPalette = new int[256];
    public static final byte[][] TINCTURE_RAMPS = new byte[][]{
            { 0, 0, 0, 0 },
            { 1, 1, 1, 3 },
            { 1, 1, 2, 4 },
            { 1, 1, 3, 5 },
    ...
    public static final int[][] TINCTURE_RAMP_VALUES = new int[][]{
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0x180d13ff, 0x180d13ff, 0x180d13ff, 0x453935ff },
            { 0x180d13ff, 0x180d13ff, 0x3c1c24ff, 0x36584eff },
            { 0x180d13ff, 0x180d13ff, 0x453935ff, 0x68705fff },
            { 0x180d13ff, 0x3c1c24ff, 0x36584eff, 0x68705fff },
            { 0x453935ff, 0x36584eff, 0x68705fff, 0xaa6567ff },
            { 0x4e2b72ff, 0x50639eff, 0x688795ff, 0xbe97b6ff },
            { 0x68705fff, 0x858138ff, 0xbfbc85ff, 0xf7c78aff },
            { 0x68a1a2ff, 0xbe97b6ff, 0xc9d7dfff, 0xdcfdecff },
            { 0xe3b5caff, 0xc9d7dfff, 0xdcfdecff, 0xdcfdecff },
            { 0x453935ff, 0x91264bff, 0x34875dff, 0xaa6567ff },
            { 0xb833d4ff, 0x688795ff, 0x44bfd7ff, 0xbe97b6ff },
            { 0xb833d4ff, 0xef73e1ff, 0x22fee7ff, 0xef73e1ff },
            { 0x5f81cfff, 0x68a1a2ff, 0xa087f6ff, 0xa1b4e1ff },
            { 0x180d13ff, 0x250863ff, 0x0000ffff, 0x250863ff },
            { 0x250863ff, 0x4e2b72ff, 0x3d23c3ff, 0x4e2b72ff },
            { 0x180d13ff, 0x180d13ff, 0x250863ff, 0x4e2b72ff },
            { 0x250863ff, 0x36584eff, 0x8e168eff, 0x36584eff },
            { 0x4e2b72ff, 0x50639eff, 0xb833d4ff, 0x688795ff },
            { 0x688795ff, 0x44bfd7ff, 0xf529f8ff, 0x44bfd7ff },
            { 0x68a1a2ff, 0xa1b4e1ff, 0xef73e1ff, 0xa1b4e1ff },
            { 0x68a1a2ff, 0xbe97b6ff, 0xe3b5caff, 0xdcfdecff },
            { 0x43be84ff, 0xbe97b6ff, 0xf68499ff, 0xbfbc85ff },
            { 0x0a8b03ff, 0x1abb3dff, 0xed1f0bff, 0x1abb3dff },
            { 0x34875dff, 0x68705fff, 0xb75028ff, 0x68705fff },
            { 0x180d13ff, 0x1e4317ff, 0x7c230dff, 0x1b692fff },
            { 0x74a729ff, 0x858138ff, 0xe26f41ff, 0x53da48ff },
            { 0x626200ff, 0x74a729ff, 0xff7f00ff, 0x53da48ff },
            { 0x53da48ff, 0xbfbc85ff, 0xf7c78aff, 0xc9d7dfff },
            { 0xbdeb68ff, 0xf7dd4cff, 0xffff00ff, 0xf7dd4cff },
            { 0x858138ff, 0xbfbc85ff, 0xb4ba29ff, 0xbfbc85ff },
            { 0x626200ff, 0x68705fff, 0x858138ff, 0x68705fff },
            { 0x3c1c24ff, 0x453935ff, 0x0a8b03ff, 0x91264bff },
            { 0xb51e2aff, 0x91264bff, 0x1abb3dff, 0xaa6567ff },
            { 0xb51e2aff, 0xb75028ff, 0x00ff00ff, 0xaa6567ff },
            { 0xeba281ff, 0xbfbc85ff, 0xbdeb68ff, 0xf7c78aff },
            { 0x34875dff, 0x68705fff, 0xaa6567ff, 0x688795ff },
            { 0x688795ff, 0x68a1a2ff, 0xbe97b6ff, 0xa1b4e1ff },
            { 0x74a729ff, 0x53da48ff, 0xeba281ff, 0xbdeb68ff },
            { 0x68705fff, 0xaa6567ff, 0x43be84ff, 0xaa6567ff },
            { 0xef73e1ff, 0xbe97b6ff, 0x65dfdbff, 0xbe97b6ff },
            { 0x180d13ff, 0x180d13ff, 0x1e4317ff, 0x91264bff },
            { 0x3c1c24ff, 0x453935ff, 0x1b692fff, 0x453935ff },
            { 0x8e168eff, 0x50639eff, 0x68a1a2ff, 0xbe97b6ff },
            { 0xa087f6ff, 0xbe97b6ff, 0xa1b4e1ff, 0xc9d7dfff },
            { 0x50639eff, 0x688795ff, 0x5f81cfff, 0x688795ff },
            { 0x250863ff, 0x4e2b72ff, 0x50639eff, 0x5f81cfff },
            { 0x3c1c24ff, 0x36584eff, 0x4e2b72ff, 0x36584eff },
            { 0x3d23c3ff, 0x50639eff, 0x6053dbff, 0x50639eff },
            { 0x5f81cfff, 0x688795ff, 0xa362ebff, 0x68a1a2ff },
            { 0x34875dff, 0x43be84ff, 0xe94889ff, 0x43be84ff },
            { 0x0a8b03ff, 0x1b692fff, 0xb51e2aff, 0x34875dff },
            { 0xa7960cff, 0xbfbc85ff, 0xefb02aff, 0xbfbc85ff },
            { 0x7c230dff, 0x453935ff, 0x626200ff, 0x68705fff },
            { 0x626200ff, 0x858138ff, 0xa7960cff, 0x858138ff },
            { 0xbfbc85ff, 0xf7c78aff, 0xf7dd4cff, 0xf7c78aff },
            { 0xb75028ff, 0xaa6567ff, 0x53da48ff, 0xaa6567ff },
            { 0x626200ff, 0xb75028ff, 0x74a729ff, 0xaa6567ff },
            { 0xe94889ff, 0xbe97b6ff, 0x43f69eff, 0xbe97b6ff },
            { 0x50639eff, 0xb833d4ff, 0x2da0efff, 0xa362ebff },
            { 0x250863ff, 0x3d23c3ff, 0x7f00ffff, 0x50639eff },
            { 0x44bfd7ff, 0xa1b4e1ff, 0xd7a5ffff, 0xc9d7dfff },
            { 0x36584eff, 0x34875dff, 0xcc197bff, 0x34875dff },
            { 0x1b692fff, 0x36584eff, 0x91264bff, 0x34875dff },
    };
    private static final int[][] TINCTURE_BONUS_RAMP_VALUES = new int[][] {
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0x10070CFF, 0x130B0FFF, 0x180D13FF, 0x1C1518FF },
            { 0x2A1016FF, 0x2F191EFF, 0x3C1C24FF, 0x432F34FF },
            { 0x2E2421FF, 0x38302DFF, 0x453935FF, 0x57504DFF },
            { 0x203B33FF, 0x2F4740FF, 0x36584EFF, 0x576D66FF },
            { 0x43493CFF, 0x575C50FF, 0x68705FFF, 0x8E9489FF },
            { 0x405964FF, 0x596F79FF, 0x688795FF, 0x9BB0B9FF },
            { 0x7D7B4FFF, 0x9E9B75FF, 0xBFBC85FF, 0xFCFAD6FF },
            { 0x818C93FF, 0xA8B2B8FF, 0xC9D7DFFF, 0xFFFFFFFF },
            { 0x8CA799FF, 0xB9D0C4FF, 0xDCFDECFF, 0xFFFFFFFF },
            { 0x1A5D3BFF, 0x316B4EFF, 0x34875DFF, 0x679D81FF },
            { 0x208396FF, 0x4399AAFF, 0x44BFD7FF, 0x94E4F4FF },
            { 0x01B2A0FF, 0x2DC8B8FF, 0x22FEE7FF, 0x8CFFFFFF },
            { 0x6854ADFF, 0x8573C1FF, 0xA087F6FF, 0xD7C7FFFF },
            { 0x0000C8FF, 0x0404B7FF, 0x0000FFFF, 0x1616BCFF },
            { 0x271292FF, 0x332191FF, 0x3D23C3FF, 0x5544ACFF },
            { 0x19014AFF, 0x1D0949FF, 0x250863FF, 0x2D1A55FF },
            { 0x650565FF, 0x6E1A6EFF, 0x8E168EFF, 0x964796FF },
            { 0x811698FF, 0x9133A4FF, 0xB833D4FF, 0xCD76DFFF },
            { 0xAF0BB1FF, 0xBE2FC0FF, 0xF529F8FF, 0xFF7FFFFF },
            { 0xA5419AFF, 0xBE67B4FF, 0xEF73E1FF, 0xFFC6FFFF },
            { 0x987383FF, 0xB999A8FF, 0xE3B5CAFF, 0xFFFFFFFF },
            { 0xAA4F60FF, 0xC47382FF, 0xF68499FF, 0xFFD2E0FF },
            { 0xAE0800FF, 0xB42315FF, 0xED1F0BFF, 0xE45E51FF },
            { 0x812F0FFF, 0x8F472AFF, 0xB75028FF, 0xC78469FF },
            { 0x591200FF, 0x5F2111FF, 0x7C230DFF, 0x7F4436FF },
            { 0x9F421DFF, 0xB26141FF, 0xE26F41FF, 0xFBB092FF },
            { 0xB44E00FF, 0xC76E14FF, 0xFF7F00FF, 0xFFC26FFF },
            { 0xA6804FFF, 0xC8A77CFF, 0xF7C78AFF, 0xFFFFEDFF },
            { 0xABAB00FF, 0xD0D01DFF, 0xFFFF00FF, 0xFFFF9CFF },
            { 0x777C07FF, 0x949832FF, 0xB4BA29FF, 0xE9ED8FFF },
            { 0x58551AFF, 0x6D6A37FF, 0x858138FF, 0xACA979FF },
            { 0x006400FF, 0x106B0BFF, 0x0A8B03FF, 0x3A8E35FF },
            { 0x048520FF, 0x209139FF, 0x1ABB3DFF, 0x5EC775FF },
            { 0x00B900FF, 0x10C310FF, 0x00FF00FF, 0x59FF59FF },
            { 0x799E35FF, 0x9FBF63FF, 0xBDEB68FF, 0xFFFFD1FF },
            { 0x753D3FFF, 0x885758FF, 0xAA6567FF, 0xC89B9CFF },
            { 0x7F5F78FF, 0x9B8096FF, 0xBE97B6FF, 0xF3D9EDFF },
            { 0xA0664BFF, 0xBD8A72FF, 0xEBA281FF, 0xFFEBD6FF },
            { 0x218455FF, 0x40976EFF, 0x43BE84FF, 0x8BDBB6FF },
            { 0x369895FF, 0x5EB3B0FF, 0x65DFDBFF, 0xBEFFFFFF },
            { 0x102E0BFF, 0x1B3516FF, 0x1E4317FF, 0x354D30FF },
            { 0x0B4A1BFF, 0x1B5229FF, 0x1B692FFF, 0x41744EFF },
            { 0x3E6C6DFF, 0x5B8384FF, 0x68A1A2FF, 0xA6CBCBFF },
            { 0x667599FF, 0x8895B5FF, 0xA1B4E1FF, 0xE6F2FFFF },
            { 0x395493FF, 0x536BA1FF, 0x5F81CFFF, 0x96ACDFFF },
            { 0x31406FFF, 0x45527BFF, 0x50639EFF, 0x7986ACFF },
            { 0x341851FF, 0x3F2658FF, 0x4E2B72FF, 0x604978FF },
            { 0x3D32A0FF, 0x5148A7FF, 0x6053DBFF, 0x887FD8FF },
            { 0x6D39A7FF, 0x8457B7FF, 0xA362EBFF, 0xCCA1FBFF },
            { 0xA52458FF, 0xB64472FF, 0xE94889FF, 0xFA91BCFF },
            { 0x840A14FF, 0x8A2029FF, 0xB51E2AFF, 0xB45159FF },
            { 0xA47106FF, 0xBF9335FF, 0xEFB02AFF, 0xFFF39BFF },
            { 0x414100FF, 0x50500BFF, 0x626200FF, 0x7C7C3CFF },
            { 0x716300FF, 0x877B1AFF, 0xA7960CFF, 0xCEC369FF },
            { 0xA6911DFF, 0xC9B751FF, 0xF7DD4CFF, 0xFFFFC7FF },
            { 0x2C9823FF, 0x4DAC46FF, 0x53DA48FF, 0x9EF797FF },
            { 0x49720DFF, 0x62862EFF, 0x74A729FF, 0xA8C977FF },
            { 0x1CAC65FF, 0x44C284FF, 0x43F69EFF, 0xA1FFDDFF },
            { 0x116DACFF, 0x3080B8FF, 0x2DA0EFFF, 0x76C1F5FF },
            { 0x5A00C0FF, 0x630ABDFF, 0x7F00FFFF, 0x8A37DEFF },
            { 0x8F67AFFF, 0xB08DCCFF, 0xD7A5FFFF, 0xFFF4FFFF },
            { 0x940453FF, 0x9C1F64FF, 0xCC197BFF, 0xCE5999FF },
            { 0x67122FFF, 0x70253FFF, 0x91264BFF, 0x98526BFF },
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0x130B0FFF, 0x180D13FF, 0x180D13FF, 0x180D13FF },
            { 0x2F191EFF, 0x3C1C24FF, 0x3C1C24FF, 0x3C1C24FF },
            { 0x38302DFF, 0x453935FF, 0x453935FF, 0x453935FF },
            { 0x2F4740FF, 0x36584EFF, 0x36584EFF, 0x36584EFF },
            { 0x575C50FF, 0x68705FFF, 0x68705FFF, 0x68705FFF },
            { 0x596F79FF, 0x688795FF, 0x688795FF, 0x688795FF },
            { 0x9E9B75FF, 0xBFBC85FF, 0xBFBC85FF, 0xBFBC85FF },
            { 0xA8B2B8FF, 0xC9D7DFFF, 0xC9D7DFFF, 0xC9D7DFFF },
            { 0xB9D0C4FF, 0xDCFDECFF, 0xDCFDECFF, 0xDCFDECFF },
            { 0x316B4EFF, 0x34875DFF, 0x34875DFF, 0x34875DFF },
            { 0x4399AAFF, 0x44BFD7FF, 0x44BFD7FF, 0x44BFD7FF },
            { 0x2DC8B8FF, 0x22FEE7FF, 0x22FEE7FF, 0x22FEE7FF },
            { 0x8573C1FF, 0xA087F6FF, 0xA087F6FF, 0xA087F6FF },
            { 0x0404B7FF, 0x0000FFFF, 0x0000FFFF, 0x0000FFFF },
            { 0x332191FF, 0x3D23C3FF, 0x3D23C3FF, 0x3D23C3FF },
            { 0x1D0949FF, 0x250863FF, 0x250863FF, 0x250863FF },
            { 0x6E1A6EFF, 0x8E168EFF, 0x8E168EFF, 0x8E168EFF },
            { 0x9133A4FF, 0xB833D4FF, 0xB833D4FF, 0xB833D4FF },
            { 0xBE2FC0FF, 0xF529F8FF, 0xF529F8FF, 0xF529F8FF },
            { 0xBE67B4FF, 0xEF73E1FF, 0xEF73E1FF, 0xEF73E1FF },
            { 0xB999A8FF, 0xE3B5CAFF, 0xE3B5CAFF, 0xE3B5CAFF },
            { 0xC47382FF, 0xF68499FF, 0xF68499FF, 0xF68499FF },
            { 0xB42315FF, 0xED1F0BFF, 0xED1F0BFF, 0xED1F0BFF },
            { 0x8F472AFF, 0xB75028FF, 0xB75028FF, 0xB75028FF },
            { 0x5F2111FF, 0x7C230DFF, 0x7C230DFF, 0x7C230DFF },
            { 0xB26141FF, 0xE26F41FF, 0xE26F41FF, 0xE26F41FF },
            { 0xC76E14FF, 0xFF7F00FF, 0xFF7F00FF, 0xFF7F00FF },
            { 0xC8A77CFF, 0xF7C78AFF, 0xF7C78AFF, 0xF7C78AFF },
            { 0xD0D01DFF, 0xFFFF00FF, 0xFFFF00FF, 0xFFFF00FF },
            { 0x949832FF, 0xB4BA29FF, 0xB4BA29FF, 0xB4BA29FF },
            { 0x6D6A37FF, 0x858138FF, 0x858138FF, 0x858138FF },
            { 0x106B0BFF, 0x0A8B03FF, 0x0A8B03FF, 0x0A8B03FF },
            { 0x209139FF, 0x1ABB3DFF, 0x1ABB3DFF, 0x1ABB3DFF },
            { 0x10C310FF, 0x00FF00FF, 0x00FF00FF, 0x00FF00FF },
            { 0x9FBF63FF, 0xBDEB68FF, 0xBDEB68FF, 0xBDEB68FF },
            { 0x885758FF, 0xAA6567FF, 0xAA6567FF, 0xAA6567FF },
            { 0x9B8096FF, 0xBE97B6FF, 0xBE97B6FF, 0xBE97B6FF },
            { 0xBD8A72FF, 0xEBA281FF, 0xEBA281FF, 0xEBA281FF },
            { 0x40976EFF, 0x43BE84FF, 0x43BE84FF, 0x43BE84FF },
            { 0x5EB3B0FF, 0x65DFDBFF, 0x65DFDBFF, 0x65DFDBFF },
            { 0x1B3516FF, 0x1E4317FF, 0x1E4317FF, 0x1E4317FF },
            { 0x1B5229FF, 0x1B692FFF, 0x1B692FFF, 0x1B692FFF },
            { 0x5B8384FF, 0x68A1A2FF, 0x68A1A2FF, 0x68A1A2FF },
            { 0x8895B5FF, 0xA1B4E1FF, 0xA1B4E1FF, 0xA1B4E1FF },
            { 0x536BA1FF, 0x5F81CFFF, 0x5F81CFFF, 0x5F81CFFF },
            { 0x45527BFF, 0x50639EFF, 0x50639EFF, 0x50639EFF },
            { 0x3F2658FF, 0x4E2B72FF, 0x4E2B72FF, 0x4E2B72FF },
            { 0x5148A7FF, 0x6053DBFF, 0x6053DBFF, 0x6053DBFF },
            { 0x8457B7FF, 0xA362EBFF, 0xA362EBFF, 0xA362EBFF },
            { 0xB64472FF, 0xE94889FF, 0xE94889FF, 0xE94889FF },
            { 0x8A2029FF, 0xB51E2AFF, 0xB51E2AFF, 0xB51E2AFF },
            { 0xBF9335FF, 0xEFB02AFF, 0xEFB02AFF, 0xEFB02AFF },
            { 0x50500BFF, 0x626200FF, 0x626200FF, 0x626200FF },
            { 0x877B1AFF, 0xA7960CFF, 0xA7960CFF, 0xA7960CFF },
            { 0xC9B751FF, 0xF7DD4CFF, 0xF7DD4CFF, 0xF7DD4CFF },
            { 0x4DAC46FF, 0x53DA48FF, 0x53DA48FF, 0x53DA48FF },
            { 0x62862EFF, 0x74A729FF, 0x74A729FF, 0x74A729FF },
            { 0x44C284FF, 0x43F69EFF, 0x43F69EFF, 0x43F69EFF },
            { 0x3080B8FF, 0x2DA0EFFF, 0x2DA0EFFF, 0x2DA0EFFF },
            { 0x630ABDFF, 0x7F00FFFF, 0x7F00FFFF, 0x7F00FFFF },
            { 0xB08DCCFF, 0xD7A5FFFF, 0xD7A5FFFF, 0xD7A5FFFF },
            { 0x9C1F64FF, 0xCC197BFF, 0xCC197BFF, 0xCC197BFF },
            { 0x70253FFF, 0x91264BFF, 0x91264BFF, 0x91264BFF },
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0x10070CFF, 0x130B0FFF, 0x180D13FF, 0x1C1518FF },
            { 0x2A1016FF, 0x2F191EFF, 0x3C1C24FF, 0x432F34FF },
            { 0x2E2421FF, 0x38302DFF, 0x453935FF, 0x57504DFF },
            ...
            { 0x67122FFF, 0x70253FFF, 0x91264BFF, 0x98526BFF },
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0x180D13FF, 0x130B0FFF, 0x180D13FF, 0x1C1518FF },
            { 0x3C1C24FF, 0x2F191EFF, 0x3C1C24FF, 0x432F34FF },
            { 0x453935FF, 0x38302DFF, 0x453935FF, 0x57504DFF },
            { 0x36584EFF, 0x2F4740FF, 0x36584EFF, 0x576D66FF },
            { 0x68705FFF, 0x575C50FF, 0x68705FFF, 0x8E9489FF },
            { 0x688795FF, 0x596F79FF, 0x688795FF, 0x9BB0B9FF },
            { 0xBFBC85FF, 0x9E9B75FF, 0xBFBC85FF, 0xFCFAD6FF },
            { 0xC9D7DFFF, 0xA8B2B8FF, 0xC9D7DFFF, 0xFFFFFFFF },
            { 0xDCFDECFF, 0xB9D0C4FF, 0xDCFDECFF, 0xFFFFFFFF },
            { 0x34875DFF, 0x316B4EFF, 0x34875DFF, 0x679D81FF },
            { 0x44BFD7FF, 0x4399AAFF, 0x44BFD7FF, 0x94E4F4FF },
            { 0x22FEE7FF, 0x2DC8B8FF, 0x22FEE7FF, 0x8CFFFFFF },
            { 0xA087F6FF, 0x8573C1FF, 0xA087F6FF, 0xD7C7FFFF },
            { 0x0000FFFF, 0x0404B7FF, 0x0000FFFF, 0x1616BCFF },
            { 0x3D23C3FF, 0x332191FF, 0x3D23C3FF, 0x5544ACFF },
            { 0x250863FF, 0x1D0949FF, 0x250863FF, 0x2D1A55FF },
            { 0x8E168EFF, 0x6E1A6EFF, 0x8E168EFF, 0x964796FF },
            { 0xB833D4FF, 0x9133A4FF, 0xB833D4FF, 0xCD76DFFF },
            { 0xF529F8FF, 0xBE2FC0FF, 0xF529F8FF, 0xFF7FFFFF },
            { 0xEF73E1FF, 0xBE67B4FF, 0xEF73E1FF, 0xFFC6FFFF },
            { 0xE3B5CAFF, 0xB999A8FF, 0xE3B5CAFF, 0xFFFFFFFF },
            { 0xF68499FF, 0xC47382FF, 0xF68499FF, 0xFFD2E0FF },
            { 0xED1F0BFF, 0xB42315FF, 0xED1F0BFF, 0xE45E51FF },
            { 0xB75028FF, 0x8F472AFF, 0xB75028FF, 0xC78469FF },
            { 0x7C230DFF, 0x5F2111FF, 0x7C230DFF, 0x7F4436FF },
            { 0xE26F41FF, 0xB26141FF, 0xE26F41FF, 0xFBB092FF },
            { 0xFF7F00FF, 0xC76E14FF, 0xFF7F00FF, 0xFFC26FFF },
            { 0xF7C78AFF, 0xC8A77CFF, 0xF7C78AFF, 0xFFFFEDFF },
            { 0xFFFF00FF, 0xD0D01DFF, 0xFFFF00FF, 0xFFFF9CFF },
            { 0xB4BA29FF, 0x949832FF, 0xB4BA29FF, 0xE9ED8FFF },
            { 0x858138FF, 0x6D6A37FF, 0x858138FF, 0xACA979FF },
            { 0x0A8B03FF, 0x106B0BFF, 0x0A8B03FF, 0x3A8E35FF },
            { 0x1ABB3DFF, 0x209139FF, 0x1ABB3DFF, 0x5EC775FF },
            { 0x00FF00FF, 0x10C310FF, 0x00FF00FF, 0x59FF59FF },
            { 0xBDEB68FF, 0x9FBF63FF, 0xBDEB68FF, 0xFFFFD1FF },
            { 0xAA6567FF, 0x885758FF, 0xAA6567FF, 0xC89B9CFF },
            { 0xBE97B6FF, 0x9B8096FF, 0xBE97B6FF, 0xF3D9EDFF },
            { 0xEBA281FF, 0xBD8A72FF, 0xEBA281FF, 0xFFEBD6FF },
            { 0x43BE84FF, 0x40976EFF, 0x43BE84FF, 0x8BDBB6FF },
            { 0x65DFDBFF, 0x5EB3B0FF, 0x65DFDBFF, 0xBEFFFFFF },
            { 0x1E4317FF, 0x1B3516FF, 0x1E4317FF, 0x354D30FF },
            { 0x1B692FFF, 0x1B5229FF, 0x1B692FFF, 0x41744EFF },
            { 0x68A1A2FF, 0x5B8384FF, 0x68A1A2FF, 0xA6CBCBFF },
            { 0xA1B4E1FF, 0x8895B5FF, 0xA1B4E1FF, 0xE6F2FFFF },
            { 0x5F81CFFF, 0x536BA1FF, 0x5F81CFFF, 0x96ACDFFF },
            { 0x50639EFF, 0x45527BFF, 0x50639EFF, 0x7986ACFF },
            { 0x4E2B72FF, 0x3F2658FF, 0x4E2B72FF, 0x604978FF },
            { 0x6053DBFF, 0x5148A7FF, 0x6053DBFF, 0x887FD8FF },
            { 0xA362EBFF, 0x8457B7FF, 0xA362EBFF, 0xCCA1FBFF },
            { 0xE94889FF, 0xB64472FF, 0xE94889FF, 0xFA91BCFF },
            { 0xB51E2AFF, 0x8A2029FF, 0xB51E2AFF, 0xB45159FF },
            { 0xEFB02AFF, 0xBF9335FF, 0xEFB02AFF, 0xFFF39BFF },
            { 0x626200FF, 0x50500BFF, 0x626200FF, 0x7C7C3CFF },
            { 0xA7960CFF, 0x877B1AFF, 0xA7960CFF, 0xCEC369FF },
            { 0xF7DD4CFF, 0xC9B751FF, 0xF7DD4CFF, 0xFFFFC7FF },
            { 0x53DA48FF, 0x4DAC46FF, 0x53DA48FF, 0x9EF797FF },
            { 0x74A729FF, 0x62862EFF, 0x74A729FF, 0xA8C977FF },
            { 0x43F69EFF, 0x44C284FF, 0x43F69EFF, 0xA1FFDDFF },
            { 0x2DA0EFFF, 0x3080B8FF, 0x2DA0EFFF, 0x76C1F5FF },
            { 0x7F00FFFF, 0x630ABDFF, 0x7F00FFFF, 0x8A37DEFF },
            { 0xD7A5FFFF, 0xB08DCCFF, 0xD7A5FFFF, 0xFFF4FFFF },
            { 0xCC197BFF, 0x9C1F64FF, 0xCC197BFF, 0xCE5999FF },
            { 0x91264BFF, 0x70253FFF, 0x91264BFF, 0x98526BFF },
    };
...
//        }
        ...
        for (int i = 0; i < 64; i++) {
            ...
            System.arraycopy(TINCTURE_BONUS_RAMP_VALUES[i], 0, TinctureBonusPalette, i << 2, 4);
...
//    };
    ...
    public static final Colorizer TinctureBonusColorizer = new Colorizer(new PaletteReducer(Coloring.TINCTURE64)) {
        private final byte[] primary = {
        ...
        public byte brighten(byte voxel) {
            ...
            // denote a structural change to the voxel's makeup, so this uses the first 64 voxel colors to shade both
            // halves, then marks voxels from the second half back to being an unshaded voxel as the last step.
            return (byte) (TINCTURE_RAMPS[voxel & 0x3F][3] | (voxel & 0xC0));
        }
        ...
        public byte darken(byte voxel) {
            ...
            // denote a structural change to the voxel's makeup, so this uses the first 64 voxel colors to shade both
            // halves, then marks voxels from the second half back to being an unshaded voxel as the last step.
            return (byte) (TINCTURE_RAMPS[voxel & 0x3F][1] | (voxel & 0xC0));
        }

        @Override
        public int dimmer(int brightness, byte voxel) {
            return TINCTURE_BONUS_RAMP_VALUES[voxel & 0xFF][
                    brightness <= 0
                            ? 0
                            : Math.min(brightness, 3)
                    ];
