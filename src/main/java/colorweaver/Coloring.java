...
//    };
     ...
     * 12 primary hues, effectively the 6 primary colors and the half-way colors between them). Like Yam4, these colors
     * all have human-readable names in colorful-gdx, if needed.
     */
    public static final int[] YAM3 = new int[]{
            0x00000000, 0x000000FF, 0x121212FF, 0x242424FF, 0x363636FF, 0x494949FF, 0x5B5B5BFF, 0x6D6D6DFF,
            0x7F7F7FFF, 0x929292FF, 0xA4A4A4FF, 0xB6B6B6FF, 0xC9C9C9FF, 0xDBDBDBFF, 0xEDEDEDFF, 0xFFFFFFFF,
            0x603129FF, 0x7F4B41FF, 0x9F665BFF, 0xC18377FF, 0xE8A598FF, 0x614C43FF, 0x80685EFF, 0x9A8176FF,
            0xB69B8FFF, 0xD7BBAFFF, 0x674732FF, 0x826049FF, 0xA07B62FF, 0xC0987EFF, 0xE5BB9FFF, 0x68573DFF,
            0x8C795CFF, 0xAA9777FF, 0xC5B18FFF, 0xE3CEABFF, 0x626438FF, 0x7F8152FF, 0x9A9D6BFF, 0xB8BB86FF,
            0xDCE0A8FF, 0x4A5C39FF, 0x647852FF, 0x82976EFF, 0xA2B88DFF, 0xC6DEB0FF, 0x3D6A41FF, 0x5A8A5EFF,
            0x74A878FF, 0x8DC390FF, 0xABE4AFFF, 0x40605EFF, 0x5A7D7BFF, 0x749996FF, 0x93BBB8FF, 0xB6E0DDFF,
            0x314474FF, 0x4C6397FF, 0x647DB6FF, 0x7A95D0FF, 0x91ADEBFF, 0x51406BFF, 0x6E5C8BFF, 0x8573A4FF,
            0x9F8BC0FF, 0xC0ABE3FF, 0x593968FF, 0x724F82FF, 0x906BA1FF, 0xB088C3FF, 0xD5AAE9FF, 0x6B426CFF,
            0x8D608EFF, 0xAB7AABFF, 0xC593C6FF, 0xE6B0E5FF, 0x91322AFF, 0xB64E44FF, 0xE27165FF, 0x85594BFF,
            0xA67767FF, 0xC99685FF, 0x935831FF, 0xB7774DFF, 0xE19B6EFF, 0x987141FF, 0xC09662FF, 0xE3B67FFF,
            0x919236FF, 0xB4B556FF, 0xDBDD79FF, 0x6C8C3BFF, 0x8EB15AFF, 0xB7DE81FF, 0x3A9844FF, 0x5BBD63FF,
            0x7BE182FF, 0x3D9192FF, 0x5DB4B5FF, 0x84DFE0FF, 0x2041A4FF, 0x3961CCFF, 0x4F7BECFF, 0x634095FF,
            0x805BB8FF, 0xA07ADDFF, 0x753697FF, 0x9754BBFF, 0xBF77E6FF, 0x994294FF, 0xBF62B9FF, 0xE27FDBFF,
            0xC3251EFF, 0xD8372DFF, 0xF04A3DFF, 0xB34834FF, 0xC65741FF, 0xD9674FFF, 0xAE563FFF, 0xC0644CFF,
            0xD5765CFF, 0xA6674CFF, 0xBA775BFF, 0xCC876AFF, 0xAF6748FF, 0xC27657FF, 0xD58766FF, 0xAF6B44FF,
            0xC27A52FF, 0xD88D63FF, 0xC66A2CFF, 0xDA7B3CFF, 0xEE8C4CFF, 0xC17732FF, 0xD28540FF, 0xE99952FF,
            0xCB8127FF, 0xE2953CFF, 0xF3A34AFF, 0xC38834FF, 0xD79A45FF, 0xEDAE57FF, 0xC59519FF, 0xDAA831FF,
            0xF2BE47FF, 0xC7B23DFF, 0xDAC550FF, 0xEED961FF, 0xC4C324FF, 0xD7D73BFF, 0xECEC50FF, 0xB2BE36FF,
            0xC6D24AFF, 0xDDEB61FF, 0xA1C82DFF, 0xB3DC42FF, 0xC7F156FF, 0x90C43EFF, 0xA0D64EFF, 0xB6EE64FF,
            0x7AC926FF, 0x8EE03EFF, 0x9EF24FFF, 0x58C540FF, 0x68D750FF, 0x7CEE63FF, 0x25C22EFF, 0x3DD742FF,
            0x56F058FF, 0x41C587FF, 0x54D898FF, 0x67ECABFF, 0x20C4A4FF, 0x3AD7B6FF, 0x53EECCFF, 0x3CC6C7FF,
            0x53DCDDFF, 0x66F0F1FF, 0x25ABCBFF, 0x3BBEDFFF, 0x50D2F4FF, 0x3282BCFF, 0x4495D2FF, 0x58AAEAFF,
            0x0B2DCFFF, 0x153FE5FF, 0x1E4EF6FF, 0x3932BCFF, 0x4341CEFF, 0x5052E3FF, 0x5621C9FF, 0x6333DDFF,
            0x7448F6FF, 0x7432BDFF, 0x8544D2FF, 0x9654E7FF, 0x8028C9FF, 0x8F39DCFF, 0xA24BF3FF, 0x8A36C5FF,
            0x9C47D9FF, 0xAB56EBFF, 0x9928CBFF, 0xAB3BE0FF, 0xBF4DF6FF, 0xA032BCFF, 0xB343D0FF, 0xC957E7FF,
            0xBB2ECFFF, 0xCF41E4FF, 0xE151F6FF, 0xBE39BEFF, 0xD24AD1FF, 0xE95DE7FF, 0xC62487FF, 0xDA3697FF,
            0xF149AAFF, 0xC4335BFF, 0xD74268FF, 0xEA5176FF, 0xFF0000FF, 0xDE4D30FF, 0xDA6340FF, 0xD17654FF,
            0xDA7A4BFF, 0xE37F4AFF, 0xF97A1BFF, 0xF98915FF, 0xFE9810FF, 0xF6A319FF, 0xFCBD00FF, 0xFFDB2EFF,
            0xFDFE0BFF, 0xE3FA31FF, 0xC5FF18FF, 0xB2FC36FF, 0x85FF00FF, 0x64FE28FF, 0x00FF22FF, 0x33F8A1FF,
            0x00FCD3FF, 0x26F9FAFF, 0x16D0FFFF, 0x129FF1FF, 0x0800FFFF, 0x3F19EEFF, 0x6709FEFF, 0x8921EEFF,
            0xA100FFFF, 0xAB24F6FF, 0xC400FEFF, 0xCB29F7FF, 0xEA17FEFF, 0xF52AF6FF, 0xFF00A6FF, 0xF72061FF,
    };

    /**
     * Created mathematically so that there are equally many colors of any particular "primary hue" this uses (there are
     * 12 primary hues, effectively the 6 primary colors and the half-way colors between them). Like Yam3, these colors
     * all have human-readable names in colorful-gdx, if needed.
     */
    public static final int[] YAM4 = {
            0x00000000, 0x000000FF, 0x121212FF, 0x242424FF, 0x363636FF, 0x494949FF, 0x5B5B5BFF, 0x6D6D6DFF,
            0x7F7F7FFF, 0x929292FF, 0xA4A4A4FF, 0xB6B6B6FF, 0xC9C9C9FF, 0xDBDBDBFF, 0xEDEDEDFF, 0xFFFFFFFF,
            0x51302DFF, 0x7E5752FF, 0xA97D78FF, 0xD4A49EFF, 0xFFCCC5FF, 0x443832FF, 0x71615BFF, 0x9B8A83FF,
            0xC6B3ABFF, 0xF0DCD3FF, 0x4E392CFF, 0x7B6254FF, 0xA78B7AFF, 0xD4B6A4FF, 0xFFDECBFF, 0x4B422DFF,
            0x776D54FF, 0xA2987CFF, 0xCFC4A6FF, 0xFBEFCFFF, 0x47472AFF, 0x727351FF, 0x9E9E79FF, 0xCACBA3FF,
            0xF5F6CCFF, 0x40482EFF, 0x6B7456FF, 0x959E7DFF, 0xBFCAA6FF, 0xEBF7D1FF, 0x324B2EFF, 0x5A7654FF,
            0x83A27CFF, 0xACCEA5FF, 0xD5F9CDFF, 0x2F4747FF, 0x597474FF, 0x819F9EFF, 0xAACBCAFF, 0xD5F8F7FF,
            0x253453FF, 0x4A5C80FF, 0x6F84ACFF, 0x93AAD6FF, 0xB8D0FFFF, 0x3B344FFF, 0x635A7BFF, 0x8A81A6FF,
            0xB1A8CFFF, 0xDACFFAFF, 0x473151FF, 0x72587EFF, 0x9B7EA8FF, 0xC4A5D3FF, 0xEECDFEFF, 0x503143FF,
            0x7C576CFF, 0xA77D94FF, 0xD2A4BDFF, 0xFCCCE6FF, 0x7E342AFF, 0xBA6356FF, 0xF49383FF, 0x6A4E42FF,
            0xA18072FF, 0xD9B3A3FF, 0x795031FF, 0xB68562FF, 0xF2BB94FF, 0x736738FF, 0xAFA26CFF, 0xECDDA2FF,
            0x727432FF, 0xAEB068FF, 0xE9EC9DFF, 0x5C753CFF, 0x94B171FF, 0xCEEEA7FF, 0x3F7934FF, 0x74B567FF,
            0xA8EE99FF, 0x3A7675FF, 0x71B3B1FF, 0xA6EEECFF, 0x1B3882FF, 0x4369BEFF, 0x6C97F5FF, 0x4D3579FF,
            0x8067B6FF, 0xB196EEFF, 0x65377FFF, 0x9C68BAFF, 0xD299F5FF, 0x7B3660FF, 0xB76696FF, 0xF096CAFF,
            0xB1271FFF, 0xD64539FF, 0xF96051FF, 0xA54A36FF, 0xCC6952FF, 0xF38970FF, 0x8D4E3CFF, 0xAB6753FF,
            0xC57D68FF, 0x9A5C42FF, 0xBB785CFF, 0xDD9677FF, 0x9F6649FF, 0xC78869FF, 0xF0AD8BFF, 0x9A5E37FF,
            0xB6764CFF, 0xD28E63FF, 0xAC6228FF, 0xD38346FF, 0xF6A162FF, 0xAF7A37FF, 0xDAA15AFF, 0xFFC97CFF,
            0xA57B2CFF, 0xC39645FF, 0xE2B360FF, 0xAD952CFF, 0xD0B84DFF, 0xF4DA6CFF, 0xB7A53AFF, 0xE2D062FF,
            0xFFF9B3FF, 0xA79C2FFF, 0xC5BA4CFF, 0xDFD464FF, 0xA9AD26FF, 0xCCD14BFF, 0xF0F76CFF, 0xAAB442FF,
            0xD5E16AFF, 0xFFFFEBFF, 0x8DA42FFF, 0xA8C14BFF, 0xC3DD64FF, 0x83AD29FF, 0xA4D24CFF, 0xC7F86EFF,
            0x7BB441FF, 0xA1DF67FF, 0xDAFFAFFF, 0x5DA430FF, 0x76C14AFF, 0x90DF64FF, 0x3CB22DFF, 0x5DD64DFF,
            0x7AF76AFF, 0x3DB379FF, 0x66DFA0FF, 0x9FFFC9FF, 0x32A68CFF, 0x4EC2A6FF, 0x68DFC1FF, 0x1DADAFFF,
            0x48D1D3FF, 0x6CF6F7FF, 0x3A9CB3FF, 0x62C6DFFF, 0x90EBFFFF, 0x2571A5FF, 0x3E8CC2FF, 0x57A7E0FF,
            0x062CB7FF, 0x1A49DBFF, 0x2F65FEFF, 0x3333ADFF, 0x4952D4FF, 0x6372FCFF, 0x4629A5FF, 0x5A42C3FF,
            0x6E58DFFF, 0x6028B1FF, 0x7C46D6FF, 0x9862F9FF, 0x6E34AFFF, 0x9055D8FF, 0xB275FFFF, 0x702AA3FF,
            0x8B44C2FF, 0xA45BDFFF, 0x8828B5FF, 0xA947D9FF, 0xCA64FDFF, 0xA739B1FF, 0xD15CDBFF, 0xFB7FFEFF,
            0xA82C95FF, 0xC645B0FF, 0xE25CCAFF, 0xB42583FF, 0xD844A2FF, 0xFC5FC0FF, 0xB23664FF, 0xDB5684FF,
            0xFF74A3FF, 0xA52A40FF, 0xC34255FF, 0xDF5769FF, 0xFF0000FF, 0xDF4E31FF, 0xD56C4AFF, 0xD77951FF,
            0xD28054FF, 0xE68546FF, 0xF48000FF, 0xF19B21FF, 0xFABA2FFF, 0xFDCF00FF, 0xFFE436FF, 0xFFF031FF,
            0xFDFE0BFF, 0xE7FE36FF, 0xD6FC2EFF, 0xBAFE08FF, 0xA2FE34FF, 0x83FC2CFF, 0x2CFF00FF, 0x27FA9CFF,
            0x2BFCD5FF, 0x00FCFBFF, 0x1FCFFBFF, 0x129FF1FF, 0x0800FFFF, 0x3B1FF0FF, 0x5D1CEFFF, 0x7F00FFFF,
            0x8D1EEFFF, 0xA120EEFF, 0xC400FEFF, 0xE42BFAFF, 0xFC27E0FF, 0xFF00BDFF, 0xF82785FF, 0xF82657FF,
    };

    public static final int[] SNUGGLY255 = {
