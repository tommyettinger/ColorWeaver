...
import colorweaver.a8.OtherMath;
...
/**
 * This is just like {@link A8PaletteReducer}, except that it uses a higher-quality, slower color difference calculation
 ...
 * <br>
 * This tends to use fewer very-dark colors than PaletteReducer or {@code FastPalette}, but seems to avoid the problem
 ...
 */
public class OkCarefulReducer extends A8PaletteReducer {
    /**
     ...
     */
    public OkCarefulReducer(int[] rgbaPalette) {
        if(rgbaPalette == null)
        {
            exact(SNUGGLY, ENCODED_SNUGGLY);
            return;
     ...
     */
    public OkCarefulReducer(int[] rgbaPalette, int limit) {
        if(rgbaPalette == null)
        {
            exact(SNUGGLY, ENCODED_SNUGGLY);
            return;
     ...
     */
    public OkCarefulReducer(Color[] colorPalette) {
     ...
     * @param colorPalette an array of Color objects to use as a palette
     */
    public OkCarefulReducer(Color[] colorPalette, int limit) {
        if(colorPalette == null)
        {
            exact(SNUGGLY, ENCODED_SNUGGLY);
            return;
     ...
     */
    public OkCarefulReducer(Pixmap pixmap) {
        if(pixmap == null)
        {
            exact(SNUGGLY, ENCODED_SNUGGLY);
            return;
     ...
     */
    public OkCarefulReducer(Array<Pixmap> pixmaps) {
        if(pixmaps == null)
        {
            exact(SNUGGLY, ENCODED_SNUGGLY);
            return;
     ...
     */
    public OkCarefulReducer(int[] palette, byte[] preload)
    {
     ...
     */
    public OkCarefulReducer(Pixmap pixmap, double threshold) {
