 ...
 * 
 * While the API to this class consists solely of static methods, it is (privately) instantiable; a IntSort instance holds the
...
public final class IntSort {
	...
	public void doSort (int[] a, IntComparator c, int lo, int hi) {
		stackSize = 0;
	...
	/** Creates a IntSort instance to maintain the state of an ongoing sort.
	 * 
	 * @param a the array to be sorted
	 * @param c the comparator to determine the order of the sort */
	private IntSort(int[] a, IntComparator c) {
		this.a = a;
		this.c = c;
