...
public interface Dithered {
     ...
     */
    void setPalette(A8PaletteReducer palette);
    ...
    enum DitherAlgorithm {
         ...
         * {@link A8PaletteReducer#setDitherStrength(float)} can really change how strongly artifacts appear here, but
         ...
         * {@link A8PaletteReducer#setDitherStrength(float)} can improve the results with DIFFUSION tremendously, but the
         ...
         * {@link A8PaletteReducer#setDitherStrength(float)} has significant effect (it didn't do much in previous
         ...
         * {@link A8PaletteReducer#setDitherStrength(float)} won't do much here, but the result will have more of a
         ...
         * as calling {@link A8PaletteReducer#setDitherStrength(float)} (or its counterpart for a Gif or PNG class). These
         ...
         */
        // currently (in version 0.5.0), this is:
